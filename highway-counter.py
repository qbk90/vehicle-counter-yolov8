...
area_snow = [(270, 238), (294, 280), (592, 226), (552, 207)]
area_highway = [(282, 251), (555, 205), (590, 220), (293, 264)]
...
while True:
    ...
    for bbox in tracked_objects:
        ...
        results = cv2.pointPolygonTest(
            np.array(area_highway, np.int32), ((center_x, center_y)), False
        )
    ...
    cv2.polylines(
        ...
        [
            np.array(area_highway, np.int32)
